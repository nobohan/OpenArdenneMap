...
<qgis styleCategories="AllStyleCategories" labelsEnabled="0" version="3.16.4-Hannover" simplifyDrawingHints="1" readOnly="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 graduatedMethod="GraduatedColor" type="graduatedSymbol" enableorderby="0" symbollevels="0" attr="day(age(now(), to_date(left(&quot;osm_timestamp&quot;,10))))" forceraster="0">
    <ranges>
      ...
      <range render="true" lower="1825.000000000000000" upper="5491.381597222221899" label="> 5 ans" symbol="5"/>
    </ranges>
    <symbols>
      ...
      <symbol force_rhr="0" type="fill" name="1" alpha="1" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="197,22,27,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol force_rhr="0" type="fill" name="2" alpha="1" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="244,77,55,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <DiagramLayerSettings zIndex="0" placement="1" dist="0" showAll="1" linePlacementFlags="18" priority="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="osm_timestamp" width="-1" hidden="0"/>
