...
#bridge[render='1_outline']{
  ...
  [stylegroup='service']{
    ...
    [tracktype='grade4'] { line-width: @mini + 2; line-offset: 1; line-dasharray: 8, 8}
...
#bridge[render='3_inline']{
  ...
  [stylegroup='service'] {
    ...
    [tracktype='grade4'] { line-width: @mini + 2; line-offset: -1; line-color: #000;}
...
#roads::top {
  ...
  [stylegroup='service'] {
    ...
    [tracktype='grade4'] { line-color: #fff; line-width: @mini; }
  }
}
