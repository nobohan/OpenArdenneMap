...
#sidewalk::right {
  ...
  [stylegroup='mainroad'] {
    ...
    [zoom = 19] { line-offset: 0.5*(@large + @outline)*@z19_road; }
  ...
  [sidewalk='right'], [sidewalk='both'] {
      [zoom = 18] {line-width: @sidewalk_width;}
      [zoom = 19] {line-width: @sidewalk_width*2.5;}
  }
  line-width: 0;
}
