...
#place::village[type='village'] {
    [zoom >= 12] {
        ...
        [zoom = 16] { text-size: @text_size_l*@z16_label; text-character-spacing: 20; text-dy: 100;}
        [zoom = 17] { text-size: @text_size_l*@z17_label; text-dy: 200;}
        [zoom = 18] { text-size: @text_size_l*@z18_label; text-dy: 400;}
...
#place::small[type='isolated_dwelling'] {
    [zoom >= 14] {
        ...
        [zoom = 14] { text-size: @text_size_s*@z14_label; }
        [zoom = 15] { text-size: @text_size_s*@z15_label; text-dy: 10;}
        [zoom = 16] { text-size: @text_size_s*@z16_label; text-dy: 20;}
        [zoom = 17] { text-size: @text_size_s*@z17_label; text-dy: 40;}
        [zoom = 18] { text-size: @text_size_s*@z18_label; text-dy: 50;}
        [zoom = 19] { text-size: @text_size_s*@z19_label; text-dy: 60; }
        [zoom >= 20] { text-size: @text_size_s*@z20_label; text-dy: 70;}
    }
}
...
#area_label {
    ...
    [type='forest'] {
        ...
        [area > 5000000] {
            [zoom = 15] { text-size: @text_size_l*[area]/5000000/10; text-character-spacing: 40; }
            [zoom = 16] { text-size: @text_size_l*[area]/5000000/6; text-character-spacing: 60; }
            [zoom = 17] { text-size: @text_size_l*[area]/5000000/4; text-character-spacing: 100; }
            [zoom = 18] { text-size: @text_size_l*[area]/5000000/2; text-character-spacing: 100; }
            [zoom = 19] { text-size: @text_size_l*[area]/5000000/2; text-character-spacing: 100; }
        }
    }
}
