...
#landuse {
  [type='camp_site'] {
    ...
    line-color: @black;
    [zoom = 19] { polygon-pattern-transform: scale(2); }
  }
  [type='cemetery'] {
    [zoom <= 10] { line-width: @landuse_line_width*@z10; }
    [zoom = 11] { line-width: @landuse_line_width*@z11; }
...
#rotated_buildings {
  [building='church'] {
      marker-height: @church_marker*0.5;
      marker-file: url(../img/cross.svg);
      ...
      [zoom = 18] {marker-height: @church_marker*1;}
      [zoom = 19] {marker-height: @church_marker*2;}
...
#boundaries::other_limits1 {
  [osm_id=163268185] , [osm_id=162123361] , [osm_id=163733039], [osm_id=162458695] {
    line-color: @admin;
    line-dasharray: 10, 10;
    [zoom = 17] { line-width: 6; }
    [zoom = 18] { line-width: 6; }
