...
make_map('18km', 15000, 616200, 6402000, 'A4', 'PORTRAIT')
make_map('28km', 25000, 619000, 6403200, 'A3')
make_map('34km', 25000, 619000, 6403200, 'A3')
make_map('48km', 35000, 621000, 6406900, 'A3')
make_map('57km', 35000, 621000, 6406900, 'A3')
